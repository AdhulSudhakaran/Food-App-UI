...
export default function BodyWash({ navigation }) {
  return (
    <View style={styles.container}>

      <View style={{ flexDirection: 'row', width: '100%', alignItems: 'center' }}>
        <Icon style={styles.icon} name='arrow-back' size={35} onPress={() => navigation.navigate('HomeScreen')}></Icon>
        <Text style={{ marginLeft: 105, fontSize: 20, fontWeight: 'bold' }}>Body Wash</Text>
      </View>
      ...
      <ScrollView style={{ height: '100%', width: '100%' }}>
        <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center' ,marginBottom:30,marginTop:20}}>
          ...
          <View style={styles.itemContainer}>
            <Image style={styles.img1} source={require('../assets/bodywash1.webp')}></Image>
            <View style={{ alignItems: 'center', justifyContent: 'center', marginLeft: 35 }}>
              <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#95c904' }}>Calming</Text>
              <Text style={{ fontWeight: '500' }}>Body Wash</Text>
          ...
          <View style={styles.itemContainer}>
            <Image style={styles.img2} source={require('../assets/bodywash2.jpg')}></Image>
            <View style={{ alignItems: 'center', justifyContent: 'center', marginLeft: 35 }}>
              <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#95c904' }}>MediMix</Text>
              <Text style={{ fontWeight: '500' }}>Body Wash</Text>
              <Text style={{ backgroundColor: 'gray', height: 20, width: 60, textAlign: 'center', color: 'white', borderRadius: 7 }}>RS 999</Text>
          ...
          {/* *************************************************** */}
          <View style={styles.itemContainer}>
            <Image style={styles.img1} source={require('../assets/bodywash3.jpg')}></Image>
            <View style={{ alignItems: 'center', justifyContent: 'center', marginLeft: 35 }}>
              <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#95c904' }}>Vedix</Text>
              <Text style={{ fontWeight: '500' }}>Body Wash</Text>
              <Text style={{ backgroundColor: 'gray', height: 20, width: 60, textAlign: 'center', color: 'white', borderRadius: 7 }}>RS 999</Text>
          ...
          {/* ********************************************************* */}
          <View style={styles.itemContainer}>
            <Image style={styles.img1} source={require('../assets/bodywash4.webp')}></Image>
            <View style={{ alignItems: 'center', justifyContent: 'center', marginLeft: 35 }}>
